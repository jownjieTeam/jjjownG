    ...
    public void inflateLevels(){
        ...
        for(int i = 0; i < tbls.length; i++) {
            ...
            for(int j = 0; j < columnNum && ctr <= questionsSize; j++) {
                ...
                levelBtnList[i].setBackground((StageActivity.sevenLetter.contains(ctr)) ? getAssetImage(getActivity(), R.mipmap.star_box) : getAssetImage(getActivity(), R.mipmap.box));
